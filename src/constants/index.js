...
const socialLinks = {
	...
	linkedIn: 'https://www.linkedin.com/in/ahsan-hafeez-satti/',
	github: 'https://github.com/AhsanHafeez2525',
	whatsapp: 'https://wa.me/923463139190',
...
const testimonials = [
	{
		...
		photo: collins,
		review:
			'Extraordinary professional! It has been an honour to work with Ahsan. He is deliberate with his projecting scooping and implements with great attention to every detail. For me, one of his most important skill sets is his ability to self manage and keep our project moving forward no matter my availability or the lack thereof. No worries once you have agreed on the scoop and a course of action. A truly great person to work with.',
	},
	{
		name: 'Hannan Hashmi',
		// position: 'Co-CEO',
		...
		photo: hannan,
		review:
			'There are developers and then there is Ahsan. Ahsan is an outstanding senior software developer and an asset to any project he is involved in. He has played an invaluable role in development and management of key projects at Kapsule including: our on-demand delivery hybrid mobile apps, medical data analytics dashboards, Point of Sale system for pharmacies and more. His willingness to take responsibility, strong logical reasoning and excellent communication skills make him simply a pleasure to work with. Highliy Recommended!',
	},
	{
		...
		photo: abraham,
		review:
			'It has been am amazing experience to work with Ahsan on my app. Ahsan has been great at practically every aspect of the code. It has already been already many months that we have worked together and I still have only seen positives when working with him. He is very knowledgeable, very quick, and most importantly, he is very quick at learning new things. I had the pleasure to work alongside Ahsan and he is very resourceful when it comes to finding a solution to a problem.',
	},
	{
		name: 'Adi Shaked',
		// position: 'CEO',
		...
		photo: wbsender,
		review:
			'Ahsan really understood my project and went above and beyond in order to complete it. Project was completed with perfect comprehension and the final result was much better than I expected. Here you hand over your project to a developer who knows what he is doing. I would highly recommend Ahsan',
	},
];
const experiences = [
	{
	...
	},
	{
		...
		company_name: 'Appic Solutions - Pakistan',
		icon: appicslogo,
		iconBg: '#383E56',
		...
		points: [
			...
			'Expanded my development skills, gaining expertise in various Web and App techniques such as aws, GraphQl, TypeScript, and responsive Layout.',
			'Engaged in continuous learning, staying updated with the latest advancements in Web and App development to deliver innovative solutions.',
		],
	},
];
...
const projects = [
	{
		...
		description:
			"Lengo is a language-learning app that provides users with all they need to master their desired language. It's been proven that LENGO's support for instant feedback, repeated content, and other effective methods can greatly shorten the time required to learn a new language.",
		github_link: null,
		playstore_link:
			'https://play.google.com/store/apps/details?id=com.lengo.uni',
		appstore_link:
			'https://apps.apple.com/us/app/learn-languages-with-lengo/id1267779816',
		website_link: 'https://www.lengo.io/',
	},
	{
		image: azima_project,
		// image: azima2x,
